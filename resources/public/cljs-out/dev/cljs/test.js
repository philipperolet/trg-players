...
var G__10557 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__10557,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__10557;
}
});
...
var len__4730__auto___10562 = arguments.length;
var i__4731__auto___10563 = (0);
while(true){
if((i__4731__auto___10563 < len__4730__auto___10562)){
args__4736__auto__.push((arguments[i__4731__auto___10563]));

var G__10564 = (i__4731__auto___10563 + (1));
i__4731__auto___10563 = G__10564;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq10559){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10560,G__10561,seq10559__$2);
});
...
var file = cljs.core.get.call(null,map__10566__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__10566__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__10566__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__10566,map__10566__$1,file,line,column){
return (function (p1__10565_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__10565_SHARP_));
});})(map__10566,map__10566__$1,file,line,column))
...
var temp__5457__auto___10568 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10568)){
var message_10569 = temp__5457__auto___10568;
cljs.core.println.call(null,message_10569);
} else {
}
...
var temp__5457__auto___10570 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10570)){
var message_10571 = temp__5457__auto___10570;
cljs.core.println.call(null,message_10571);
} else {
}
...
var output_dir__$1 = (function (){var G__10572 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__10572,"/"].join('');
} else {
return G__10572;
}
})();
...
var G__10574 = exception.stack;
var G__10574__$1 = (((G__10574 == null))?null:clojure.string.split_lines.call(null,G__10574));
var G__10574__$2 = (((G__10574__$1 == null))?null:cljs.core.get.call(null,G__10574__$1,depth));
if((G__10574__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__10574__$2);
}
} else {
...
var vec__10575 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__10575,(0),null);
var column = cljs.core.nth.call(null,vec__10575,(1),null);
var vec__10578 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__10578,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__10578,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__10578,(2),null);
...
var m__$1 = (function (){var G__10581 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__10585 = (function (){var G__10584 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__10584);
} else {
return G__10584;
}
})();
...
return cljs.core.vary_meta.call(null,G__10586,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__10590 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__10590,(0),null);
var types = vec__10590;
...
return cljs.core.map.call(null,(function (p__10593){
var vec__10594 = p__10593;
var ns = cljs.core.nth.call(null,vec__10594,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__10594,(1),null);
return ((function (vec__10594,ns,vars__$1){
return (function (){
...
var G__10597 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__10597,G__10597__$1,env,once_fixtures,each_fixtures,vec__10594,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__10597,G__10597__$1,env,once_fixtures,each_fixtures,vec__10594,ns,vars__$1){
return (function (){
var seq__10598 = cljs.core.seq.call(null,vars__$1);
var chunk__10599 = null;
var count__10600 = (0);
var i__10601 = (0);
while(true){
if((i__10601 < count__10600)){
var v = cljs.core._nth.call(null,chunk__10599,i__10601);
var temp__5457__auto___10603 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___10603)){
var t_10604 = temp__5457__auto___10603;
each_fixture_fn.call(null,((function (seq__10598,chunk__10599,count__10600,i__10601,t_10604,temp__5457__auto___10603,v,each_fixture_fn,G__10597,G__10597__$1,env,once_fixtures,each_fixtures,vec__10594,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10604)));
});})(seq__10598,chunk__10599,count__10600,i__10601,t_10604,temp__5457__auto___10603,v,each_fixture_fn,G__10597,G__10597__$1,env,once_fixtures,each_fixtures,vec__10594,ns,vars__$1))
);
} else {
}


var G__10605 = seq__10598;
var G__10606 = chunk__10599;
var G__10607 = count__10600;
var G__10608 = (i__10601 + (1));
seq__10598 = G__10605;
chunk__10599 = G__10606;
count__10600 = G__10607;
i__10601 = G__10608;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__10598);
if(temp__5457__auto__){
var seq__10598__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__10598__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__10598__$1);
var G__10609 = cljs.core.chunk_rest.call(null,seq__10598__$1);
var G__10610 = c__4550__auto__;
var G__10611 = cljs.core.count.call(null,c__4550__auto__);
var G__10612 = (0);
seq__10598 = G__10609;
chunk__10599 = G__10610;
count__10600 = G__10611;
i__10601 = G__10612;
continue;
} else {
var v = cljs.core.first.call(null,seq__10598__$1);
var temp__5457__auto___10613__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___10613__$1)){
var t_10614 = temp__5457__auto___10613__$1;
each_fixture_fn.call(null,((function (seq__10598,chunk__10599,count__10600,i__10601,t_10614,temp__5457__auto___10613__$1,v,seq__10598__$1,temp__5457__auto__,each_fixture_fn,G__10597,G__10597__$1,env,once_fixtures,each_fixtures,vec__10594,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10614)));
});})(seq__10598,chunk__10599,count__10600,i__10601,t_10614,temp__5457__auto___10613__$1,v,seq__10598__$1,temp__5457__auto__,each_fixture_fn,G__10597,G__10597__$1,env,once_fixtures,each_fixtures,vec__10594,ns,vars__$1))
);
} else {
}


var G__10615 = cljs.core.next.call(null,seq__10598__$1);
var G__10616 = null;
var G__10617 = (0);
var G__10618 = (0);
seq__10598 = G__10615;
chunk__10599 = G__10616;
count__10600 = G__10617;
i__10601 = G__10618;
continue;
}
} else {
...
});})(each_fixture_fn,G__10597,G__10597__$1,env,once_fixtures,each_fixtures,vec__10594,ns,vars__$1))
);
});})(each_fixture_fn,G__10597,G__10597__$1,env,once_fixtures,each_fixtures,vec__10594,ns,vars__$1))
], null);
