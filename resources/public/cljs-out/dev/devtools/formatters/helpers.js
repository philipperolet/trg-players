...
var G__12079 = devtools.prefs.pref.call(null,v);
v = G__12079;
continue;
} else {
return v;
...
}catch (e12082){var _e__11093__auto__ = e12082;
return false;
}})();
...
}catch (e12086){var _e__11093__auto__ = e12086;
return false;
}})();
...
}catch (e12088){var _e__11093__auto__ = e12088;
return false;
}}
}
});
...
var vec__12090 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__12090,(0),null);
var name = cljs.core.nth.call(null,vec__12090,(1),null);
...
return cljs.core.some.call(null,(function (p1__12093_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12093_SHARP_);
}),template);
});
