...
var o11974 = temp__5455__auto__;
var temp__5455__auto____$1 = (o11974["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o11975 = temp__5455__auto____$1;
return (o11975["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__11086__auto__ = f;
return (o__11086__auto__["toString"]).call(o__11086__auto__);
} else {
return "";
}
}catch (e11976){var _ = e11976;
return "";
}});
...
try{var o__11086__auto___11978 = t;
(o__11086__auto___11978["cljs$lang$ctorPrWriter"]).call(o__11086__auto___11978,t,writer);
}catch (e11977){var __11979 = e11977;
}
...
var char_code = (function (){var o__11086__auto__ = (new String(char$));
return (o__11086__auto__["charCodeAt"]).call(o__11086__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11086__auto__ = String;
return (o__11086__auto__["fromCharCode"]).call(o__11086__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__11980 = num_code;
switch (G__11980) {
case (1):
return (185);
...
var o__11086__auto__ = String;
return (o__11086__auto__["fromCharCode"]).call(o__11086__auto__,superscript_code);
});
/**
...
}catch (e11982){var _e__11093__auto__ = e11982;
return false;
}})())){
...
var vec__11983 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__11983,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o11986 = temp__5455__auto__;
var temp__5455__auto____$1 = (o11986["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o11987 = temp__5455__auto____$1;
return (o11987["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__11990){
var vec__11991 = p__11990;
var ns_detector = cljs.core.nth.call(null,vec__11991,(0),null);
...
var G__11997 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__11998 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__11997;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq11988){
var G__11989 = cljs.core.first.call(null,seq11988);
var seq11988__$1 = cljs.core.next.call(null,seq11988);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11989,seq11988__$1);
});
...
var vec__12002 = cljs.core.split_with.call(null,(function (p1__12001_SHARP_){
return cljs.core.not_EQ_.call(null,p1__12001_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__12002,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__12002,(1),null);
...
var vec__12008 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__12008,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__12008,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__12011 = cljs.core.rest.call(null,remaining_tokens);
var G__12012 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__12011;
name_tokens = G__12012;
continue;
} else {
...
var vec__12015 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__12015,(0),null);
var arity = cljs.core.nth.call(null,vec__12015,(1),null);
var vec__12018 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__12018,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__12018,(1),null);
var vec__12021 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__12021,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__12021,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__12021,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__12021,(3),null);
...
var vec__12027 = result;
var munged_ns = cljs.core.nth.call(null,vec__12027,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__12027,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__12027,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__12027,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__12027,(4),null);
var arity = cljs.core.nth.call(null,vec__12027,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__12031 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__12031,(0),null);
var args = cljs.core.nth.call(null,vec__12031,(1),null);
var vec__12034 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__12034,(0),null);
var name = cljs.core.nth.call(null,vec__12034,(1),null);
...
var G__12037 = (arity + (1));
var G__12038 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12039){
var vec__12040 = p__12039;
var arity = cljs.core.nth.call(null,vec__12040,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__12040,(1),null);
...
return cljs.core.get.call(null,arities,p1__12043_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__12044_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12047){
var vec__12048 = p__12047;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__12048,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12045){
var G__12046 = cljs.core.first.call(null,seq12045);
var seq12045__$1 = cljs.core.next.call(null,seq12045);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12046,seq12045__$1);
});
...
var G__12054 = arg;
var G__12054__$1 = (((G__12054 instanceof cljs.core.Keyword))?G__12054.fqn:null);
switch (G__12054__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__12056__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__12056__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__12056__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__12056__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12057 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__12057,(0),null);
var fn_name = cljs.core.nth.call(null,vec__12057,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__12057,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__12057,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__12057,(4),null);
var arity = cljs.core.nth.call(null,vec__12057,(5),null);
...
var o__11086__auto__ = f;
return (o__11086__auto__["getBasis"]).call(o__11086__auto__);
});
/**
...
}catch (e12061){var _e__11093__auto__ = e12061;
...
var G__12062 = (obj[cljs.core.first.call(null,path)]);
var G__12063 = cljs.core.rest.call(null,path);
obj = G__12062;
path = G__12063;
continue;
} else {
...
return (function (accum,p__12064){
var vec__12065 = p__12064;
var bit = cljs.core.nth.call(null,vec__12065,(0),null);
var protocol = cljs.core.nth.call(null,vec__12065,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12068){
var vec__12069 = p__12068;
var ns = cljs.core.nth.call(null,vec__12069,(0),null);
var name = cljs.core.nth.call(null,vec__12069,(1),null);
var selector = cljs.core.nth.call(null,vec__12069,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__12074,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__12074,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__12074,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__12072_SHARP_){
return (obj[cljs.core.first.call(null,p1__12072_SHARP_)]);
});})(name,sorted_matches,vec__12074,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
