...
return cljs.core.reduce.call(null,(function (result,p__12150){
...
var vec__12154 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__12154,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__12154,(1),null);
var ab = cljs.core.nth.call(null,vec__12154,(2),null);
...
return (function (){var G__12163 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12163__$1)].join('')));
